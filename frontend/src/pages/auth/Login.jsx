    ...
    <div className="min-h-screen bg-[#f5f3ee] flex flex-col md:flex-row">
      ...
      ">
        <div className="flex items-center gap-3 lg:gap-4">
          ...
          <div>
            <h1 className="font-slab md:text-xl lg:text-2xl font-semibold tracking-wide">Jewellery Billing</h1>
            <p className="font-slab md:text-xs lg:text-sm text-white/70">Jewellery Management Suite</p>
          </div>
        </div>
        ...
        <div className="font-slab md:text-xs lg:text-sm text-white/60">© 2026 Jewellery Billing</div>
      </div>

      {/* RIGHT PANEL */}
      <div className="flex-1 flex items-center justify-center px-5 md:px-8 lg:px-6 py-10 md:py-0">
        <div className="w-full max-w-[360px] md:max-w-[340px] lg:max-w-[380px]">
          <h2 className="font-slab md:text-2xl lg:text-3xl text-2xl font-bold leading-tight">Welcome back</h2>
          <p className="font-slab text-xs md:text-sm text-gray-500 mb-6 md:mb-7 mt-1">Sign in to your account</p>
          ...
          <p className="font-slab text-xs text-gray-400 text-center mt-10 md:hidden">© 2026 Jewellery Billing</p>
        </div>
      </div>
